...
### 💡 Function - Displays the void charge state while in the pilot's seat

### 🎮 Client Usage

- Install
- Configure at F5 > Mod Settings > Void Charge HUD
...
Drag and drop `VoidChargeHUD.dll` into `Void Crew\BepInEx\plugins`
